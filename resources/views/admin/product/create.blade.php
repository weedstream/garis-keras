                    ...
                    <form class="form" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Select T-shirt Category</label>
                                    <fieldset class="form-group">
                                        <select class="form-select @error('category') is-invalid @enderror" id="categorySelect" name="category">
                                            <option value="">-- Choose a category --</option>
                                            <option {{ old('category') == 'tshirt' ? 'selected' : '' }} value="T-Shirt">T-Shirt</option>
                                            <option {{ old('category') == 'hoodie' ? 'selected' : '' }} value="Hoodie">Hoodie</option>
                                            <option {{ old('category') == 'hat' ? 'selected' : '' }} value="Hat">Hat</option>
                                        </select>
                                        @error('category')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
