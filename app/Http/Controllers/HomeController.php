...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // return view('frontend.fe', compact('data', 'cart'));
    }
    ...
    public function index_fe ()
    {
        ...
        return view('frontend.fe_loop', compact('data', 'cart', 'testimonials'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (empty($cek)) {
            ...
            if (empty($cart)) {
                ...
                return redirect()->route('index')->with('success', 'Produk Berhasil Masuk Keranjang');
            } else {
                ...
                return redirect()->route('index')->with('success', 'Keranjang Berhasil di update');
            }
        }
    }
